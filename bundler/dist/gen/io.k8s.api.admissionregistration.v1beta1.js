...
(function (MutatingWebhookConfiguration) {
    MutatingWebhookConfiguration.apiVersion = "admissionregistration.k8s.io/v1beta1";
    MutatingWebhookConfiguration.group = "admissionregistration.k8s.io";
    MutatingWebhookConfiguration.version = "v1beta1";
...
(function (MutatingWebhookConfigurationList) {
    MutatingWebhookConfigurationList.apiVersion = "admissionregistration.k8s.io/v1beta1";
    MutatingWebhookConfigurationList.group = "admissionregistration.k8s.io";
    MutatingWebhookConfigurationList.version = "v1beta1";
...
(function (ValidatingWebhookConfiguration) {
    ...
    ValidatingWebhookConfiguration.version = "v1beta1";
...
(function (ValidatingWebhookConfigurationList) {
    ValidatingWebhookConfigurationList.apiVersion = "admissionregistration.k8s.io/v1beta1";
    ValidatingWebhookConfigurationList.group = "admissionregistration.k8s.io";
    ValidatingWebhookConfigurationList.version = "v1beta1";
...
//# sourceMappingURL=io.k8s.api.admissionregistration.v1beta1.js.map