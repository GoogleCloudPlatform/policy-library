...
(function (ControllerRevision) {
    ControllerRevision.apiVersion = "apps/v1beta2";
    ControllerRevision.group = "apps";
    ControllerRevision.version = "v1beta2";
...
(function (ControllerRevisionList) {
    ControllerRevisionList.apiVersion = "apps/v1beta2";
    ControllerRevisionList.group = "apps";
    ControllerRevisionList.version = "v1beta2";
...
(function (DaemonSet) {
    DaemonSet.apiVersion = "apps/v1beta2";
    DaemonSet.group = "apps";
    DaemonSet.version = "v1beta2";
...
(function (DaemonSetList) {
    DaemonSetList.apiVersion = "apps/v1beta2";
    DaemonSetList.group = "apps";
    DaemonSetList.version = "v1beta2";
...
(function (DeploymentList) {
    DeploymentList.apiVersion = "apps/v1beta2";
    DeploymentList.group = "apps";
    DeploymentList.version = "v1beta2";
...
(function (ReplicaSet) {
    ReplicaSet.apiVersion = "apps/v1beta2";
    ReplicaSet.group = "apps";
    ReplicaSet.version = "v1beta2";
...
(function (ReplicaSetList) {
    ReplicaSetList.apiVersion = "apps/v1beta2";
    ReplicaSetList.group = "apps";
    ReplicaSetList.version = "v1beta2";
...
(function (Scale) {
    Scale.apiVersion = "apps/v1beta2";
    Scale.group = "apps";
    Scale.version = "v1beta2";
    Scale.kind = "Scale";
...
(function (StatefulSetList) {
    StatefulSetList.apiVersion = "apps/v1beta2";
    StatefulSetList.group = "apps";
    StatefulSetList.version = "v1beta2";
...
//# sourceMappingURL=io.k8s.api.apps.v1beta2.js.map