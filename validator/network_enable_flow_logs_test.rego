...
test_flow_logs_internal_https_load_balance {
	not resources_in_violation["//compute.googleapis.com/projects/pso-cicd8/regions/us-west1/subnetworks/internal_https_load_balance"]
}
