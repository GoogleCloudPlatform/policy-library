...
all_violations[violation] {
	resource := data.test.fixtures.gke_enable_private_google_access.assets[_]
	constraint := data.test.fixtures.gke_enable_private_google_access.constraints.enable_gke_private_google_access

	issues := deny with input.asset as resource
		 with input.constraint as constraint
		 with data.inventory as data.test.fixtures.gke_enable_private_google_access.assets
