...
all_violations[violation] {
	resource := data.test.fixtures.gke_enable_pod_security_policy.assets[_]
	constraint := data.test.fixtures.gke_enable_pod_security_policy.constraints.enable_psp
...
good_config_no_violations[violation] {
	...
	resource.name = "//container.googleapis.com/projects/transfer-repos/zones/us-central1-c/clusters/joe-clust5"
