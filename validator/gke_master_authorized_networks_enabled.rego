...
forbidden_networks(cluster, params) = forbidden {
	...
	# We only go down this path if there are networks listed. Otherwise, the other rule
	# already checks for the existance of masterAuthorizedNetworks.
	count(allowed_authorized_networks) > 0
