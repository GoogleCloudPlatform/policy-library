...
all_violations[violation] {
	resource := data.test.fixtures.gke_enable_workload_identity.assets[_]
	constraint := data.test.fixtures.gke_enable_workload_identity.constraints
