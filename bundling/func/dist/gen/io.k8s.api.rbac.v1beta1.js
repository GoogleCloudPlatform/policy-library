...
(function (ClusterRoleBinding) {
    ...
    ClusterRoleBinding.version = "v1beta1";
...
(function (ClusterRoleBindingList) {
    ClusterRoleBindingList.apiVersion = "rbac.authorization.k8s.io/v1beta1";
    ClusterRoleBindingList.group = "rbac.authorization.k8s.io";
    ClusterRoleBindingList.version = "v1beta1";
...
(function (ClusterRoleList) {
    ...
    ClusterRoleList.version = "v1beta1";
...
(function (RoleBindingList) {
    RoleBindingList.apiVersion = "rbac.authorization.k8s.io/v1beta1";
    RoleBindingList.group = "rbac.authorization.k8s.io";
    RoleBindingList.version = "v1beta1";
...
(function (RoleList) {
    RoleList.apiVersion = "rbac.authorization.k8s.io/v1beta1";
    RoleList.group = "rbac.authorization.k8s.io";
    RoleList.version = "v1beta1";
...
//# sourceMappingURL=io.k8s.api.rbac.v1beta1.js.map