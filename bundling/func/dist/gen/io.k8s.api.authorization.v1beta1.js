...
(function (LocalSubjectAccessReview) {
    LocalSubjectAccessReview.apiVersion = "authorization.k8s.io/v1beta1";
    LocalSubjectAccessReview.group = "authorization.k8s.io";
    LocalSubjectAccessReview.version = "v1beta1";
...
(function (SelfSubjectAccessReview) {
    SelfSubjectAccessReview.apiVersion = "authorization.k8s.io/v1beta1";
    SelfSubjectAccessReview.group = "authorization.k8s.io";
    SelfSubjectAccessReview.version = "v1beta1";
...
(function (SelfSubjectRulesReview) {
    SelfSubjectRulesReview.apiVersion = "authorization.k8s.io/v1beta1";
    SelfSubjectRulesReview.group = "authorization.k8s.io";
    SelfSubjectRulesReview.version = "v1beta1";
...
(function (SubjectAccessReview) {
    SubjectAccessReview.apiVersion = "authorization.k8s.io/v1beta1";
    SubjectAccessReview.group = "authorization.k8s.io";
    SubjectAccessReview.version = "v1beta1";
...
//# sourceMappingURL=io.k8s.api.authorization.v1beta1.js.map